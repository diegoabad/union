...
import { getAreaSocial } from '../redux/actions/index';
...
const AreaSocial = ({ setOpenFiliatorio, registro }) => {

  const [terapias, setTerapias] = React.useState('');
	const dni = useSelector((state) => state.pacienteActual.filiatorios.dni);
	const paciente = useSelector((state) => state.pacienteActual.area_social);
